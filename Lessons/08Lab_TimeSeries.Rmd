...
BR_Rain_Decompsed <- stl(BR_Rain_ts, s.window = "periodic")
plot(BR_Rain_Decomp)

BR_Temp_Decompsed <- stl(BR_Temp_ts, s.window = "periodic")
plot(BR_Temp_Decompsed)
...
BR_Rain_Components <- 
  as.data.frame(BR_Rain_Decompsed$time.series[, 1:3])
BR_Temp_Components <- 
  as.data.frame(BR_Temp_Decompsed$time.series[, 1:3])
