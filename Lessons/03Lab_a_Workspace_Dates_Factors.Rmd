...
here() 
filename <- here('Data','Raw','NTL-LTER_Lake_ChemistryPhysics_Raw.csv')
print(filename)
...
# 2. Read in all CSV files starting with "EPAair_O3" into a single dataframe
library(tidyverse);library(here)
folder <- here("Data", "Raw")
files <- dir(EPA_folder, pattern = "EPAair_O3", full.names = TRUE)
