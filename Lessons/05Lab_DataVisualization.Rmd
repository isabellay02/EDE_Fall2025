...
surface_temp_by_day <- PeterPaul.chem.nutrients %>%
  ...
  facet_wrap(facets=vars(lakename),
             nrow=2)+
  labs(title = "Temperature vs Day Number",      # Title
       x = "Day Number",                         # X-axis label
       y = "Temperature (°C)",
       color="Year") +                 # Y-axis label
...
surface_temp_by_date <- PeterPaul.chem.nutrients %>%
  ...
  scale_x_date(
    date_breaks = "5 years",
    date_labels = "%Y") +
  labs(title = "Temperature vs Sample Date",      # Title
       x = "Sample Date",                         # X-axis label
       y = "Temperature (°C)",
       color="Depth (m)") +                 # Y-axis label
  theme_minimal()                               # Clean theme
surface_temp_by_date
...
AQI_plot <- EPAair %>%
  ...
  labs(title = "AQI Plot",      # Title
       x = "PM2.5",                         # X-axis label
       y = "Ozone",
       color="Mean Latitude") +                 # Y-axis label
  theme_minimal()                               # Clean theme
AQI_plot
